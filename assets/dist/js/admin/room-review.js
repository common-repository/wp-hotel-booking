...
const hbReviewImages = () => {
  ...
  (0,delegated_events__WEBPACK_IMPORTED_MODULE_1__.on)('click', '.hb-gallery-add', function (event) {
    event.preventDefault();
    const mediaElNode = this.closest('.hb-image-info');
    const hbUploader = wp.media({
      title: __('Select Images', 'wp-hotel-booking'),
      button: {
  ...
  (0,delegated_events__WEBPACK_IMPORTED_MODULE_1__.on)('click', '.hb-image-info .hb-gallery-remove', function (event) {
    event.preventDefault();
...
/*!*****************************************************!*\
  !*** ./assets/js/admin/room-review/room-review.tsx ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _images__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./images */ "./assets/js/admin/room-review/images.js");
/* harmony import */ var _advanced_review__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./advanced-review */ "./assets/js/admin/room-review/advanced-review.js");


addEventListener("DOMContentLoaded", event => {
  (0,_images__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_advanced_review__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
/******/ })()
;
